...
def pad_nd_image(
    ...
    if shape_must_be_divisible_by is not None:
        ...
        if isinstance(shape_must_be_divisible_by, int):
            ...
            if len(shape_must_be_divisible_by) < len(image.shape):
                shape_must_be_divisible_by = [1] * (len(image.shape) - len(shape_must_be_divisible_by)) + list(
    ...
    if shape_must_be_divisible_by is not None:
        ...
        if len(shape_must_be_divisible_by) < len(new_shape):
            shape_must_be_divisible_by = [1] * (len(new_shape) - len(shape_must_be_divisible_by)) + list(
                shape_must_be_divisible_by
            )
